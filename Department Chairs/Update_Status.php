...
<tr> <td>Rank</td><td> <input type="number" name="f4" min="0" class="form-control"></td> </tr>
...
<input id="button" type="submit" name="submit" class="btn btn-success" value="Update"></td> </tr> 
	...
	{					
		$sql="update request_form set d_chair_approval='".$_REQUEST["f3"]."', rank='".$_REQUEST["f4"]."' where id='".$_REQUEST["f5"]."'";
	...
	if ($connection->query($sql) === TRUE) {		
		...
		<script>
			...
			if(true)
			{
				window.location="Department_Chairs_Review.php";
			}
		</script>
		<?php
	} else {
