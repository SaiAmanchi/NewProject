...
<?php 
session_start();
if(isset($_SESSION['DepartmentChairs']) && !empty($_SESSION['DepartmentChairs']))
{
?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav" style="margin-left: 520px;">
      	  <li><a href="Department_Chairs.php" target="dept">Home</a></li>
      	  <li><a href="Department_Chairs_Review.php" target="dept">Review</a></li>
...
<div style="min-height: 470px;margin-top: 0px;">
	<iframe id="dept" name="dept" src="" style="width: 99.5%;min-height: 470px;"></iframe>
</div>
