...
<?php 
session_start();
if(isset($_SESSION['Dean']) && !empty($_SESSION['Dean']))
{
?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav" style="margin-left: 450px;">
      	  <li><a href="#">Home</a></li>
      	  <li><a href="Approve.php" target="dean">Review</a></li>
...
<div style="min-height: 470px;margin-top: 0px;">
	<iframe id="dean" name="dean" src="" style="width: 99.5%;min-height: 470px;"></iframe>
</div>
